...
my_name = "David Yang"
your_name = "David Antler" # <-- put your name here between quotes
...
my_highschool = "Horace Moon"
my_college = "Wisconsin"
my_MBA = "NYU"

puts "I went to #{my_highschool}, #{my_college}, and #{my_MBA}."
...
dates_between_events = (moon_landing - american_revolution).to_i

puts "There were #{dates_between_events} days between the American Revolution and when man landed on the moon."